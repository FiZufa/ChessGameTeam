...
public class ChessboardMain {
    ...
    public static void main(String[] args) {
        while (!"E".equals(chessBoard[kingPositionC/8][kingPositionC%8])) {kingPositionC++;}//get King's location
        while (!"e".equals(chessBoard[kingPositionL/8][kingPositionL%8])) {kingPositionL++;}//get king's location
        /*
         * PIECE=WHITE/black
         * pawn=P/p
         * kinght (horse)=K/k
        ...
        if (kingPositionC>=16) {
            ...
            for (int i=-1; i<=1; i++) {
                for (int j=-1; j<=1; j++) {
                    if (i!=0 || j!=0) {
                        try {
                            if ("e".equals(chessBoard[kingPositionC/8+i][kingPositionC%8+j])) {
                                return false;
                            }
                        } catch (Exception e) {}
                    }
